...
<body>
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 text-white">Gallery</h1>
    ...
    <!-- ======= Portfolio Section ======= -->
    <section id="portfolio" class="portfolio py-5" data-aos="fade-up">
        <h2 class="causes-heading fw-600 logo-color text-center mb-4">Our Gallery</h2>

        <div class="container-fluid" data-aos="fade-up" data-aos-delay="200">
            <div class="portfolio-isotope" data-portfolio-filter="*" data-portfolio-layout="masonry" data-portfolio-sort="original-order">
                <ul class="portfolio-flters lh-2">
                    <li data-filter="*" class="filter-active">All</li>
                    <li data-filter=".filter-Celebrity">Celebrity Interaction</li>
                    <li data-filter=".filter-Awards">Awards</li>
                    <li data-filter=".filter-Educational">Educational Tours</li>
                    <li data-filter=".filter-Exhibition">Exhibition</li>
                    <li data-filter=".filter-Fashion">Fashion Show</li>
                    <li data-filter=".filter-Festivity">Festivity</li>
                    <li data-filter=".filter-Garba">Garba</li>
                    <li data-filter=".filter-Industrial">Industrial Visits</li>
                    <li data-filter=".filter-Site">Site Visits</li>
                    <li data-filter=".filter-Traning">Training & Workshops</li>
                </ul><!-- End Portfolio Filters -->
                <div class="row g-0 portfolio-container">
                    <!-- tab1 -->
                    @foreach($galleries as $gallery)
                    <div class="col-xl-3 col-lg-4 col-md-6 portfolio-item filter-Celebrity">
                        <img src="{{'../storage/'.$gallery->path}}" class="img-fluid" alt="">
                        <div class="portfolio-info">
                            <a href="{{'../storage/'.$gallery->path}}" data-gallery="portfolio-gallery" class="glightbox preview-link"><i class="fa fa-search"></i></a>
                        </div>
                    </div>
                    @endforeach
                    <!-- End Portfolio Item -->
    ...
    <!-- Footer Start -->
    <footer>
        <div class="container-fluid bg-black-dim footer">
            <div class="container py-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6 footerz-col">
