            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav m-auto mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('our-activities')}}">Our Activities</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 text-white">Our Activities</h1>
        ...
        <div class="container">
            <div class="row ">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 pr-md-4 ftco-animate py-2">
                    ...
                    <p class=" text-justify causes-text my-text-black">In Wardhaman Nagar, Cadence Academy is the
                        premier Fashion
                        Designing and Interior Designing Institute, offering a variety of professional
                        courses in art, design, and allied fields. Our commitment to delivering quality and professional
                        educational
                        experiences
                        to our students is unwavering. We provide numerous opportunities to enrich your education beyond
                        the
                        conventional
                        classroom setting. You'll have the chance to engage in profession-related organizations, attend
                        specialized
                        workshops,
                        benefit from guest lectures, partake in field trips, and explore study programs.</p>

                    <!-- <a href="#" class="btn my-btn px-4 py-2 mt-3">Explore</a> -->
                    </a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Celebrity Interaction</h3>
                        </div>
                        <div class="imgg">
                            <img src="assets/images/celebrity-interaction/ShreyasTalpadeManjriFadnvis-800x600-1.jpg" alt="" width="100%">
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Exhibition</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Fashion Shows</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Industrial Visits</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Festivity</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Site Visit</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Educational Tours</h3>
                        </div>
                        <div class="imgg">
                ...
                <div class="col-md-4 col-sm-12">
                    <div class="boxx">
                        <div class="headingg uppercase">
                            <h3 class="text-center">Training and Workshops</h3>
                        </div>
                        <div class="imgg">
