  ...
  <section class="mt-5 mb-5">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-5 col-lg-5 pt-2 ftco-animate">
          <div class="contact-info shadow">
            <div class="resp-height">
              <div class="row">
                <div class="col-md-3 ">
                  <img src="{{ asset('assets/images/contact/map.gif')}}" alt="" width="60px">
                </div>
                <div class="col-md-9 location">
                  <p class=" mb-0 fs-4 fw-bold foot-list  text-dark">Our Office</p>
                  <p class="ms-1 mt-0 fw-bold">269 Shardha Complex, Above HDFC Bank, Avenue, Nagpur-440008, Maharashtra
                  </p>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-3 ">
                  <img src="{{asset('assets/images/contact/message.gif')}}" alt="" width="60px">
                </div>
                <div class="col-md-9 location">
                  <p class=" mb-0 fs-4 fw-bold foot-list  text-dark">Email</p>
                  <p class="ms-1 mt-0 fw-bold">admission@cadence-wn.in</p>
                </div>
              </div>

              <div class="row">
                <div class="col-md-3 ">
                  <img src="{{asset('assets/images/contact/telephone.gif')}}" alt="" width="60px">
                </div>
                <div class="col-md-9 location">
                  <p class=" mb-0 fs-4 fw-bold foot-list  text-dark">Call</p>
                  <p class="ms-1 mt-0 fw-bold">+91 9823273512/0712-2774116</p>
                </div>
              </div>

              <div class="row">
                <div class="map col-lg-12">
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14884.344355763576!2d79.10504455541992!3d21.148972!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bd4c75ba1acaba7%3A0x211e2b4cd6e932cf!2sCadence%20Academy%20(A%20La%20Mode%20Fashion%20%26%20Interior)!5e0!3m2!1sen!2sin!4v1699435254104!5m2!1sen!2sin" width="100%" height="250" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-md-7 col-lg-7 pt-2 ftco-animate">
          <div class="contact-info shadow">
            <h1 class="text-center causes-text heading1 mb-2 logo-color"><b>CONTACT FORM</b></h1>
            <form action="{{ route('contact') }}" method="post">
              ...
              @endif
              <div class="mb-3">
                <label for="exampleinputname1" class="form-label fw-bold fs-5"> Full Name</label>
                <input type="text" class="form-control" id="exampleinputname1" aria-describedby="Name" name="name" required>
              </div>

              <div class="mb-3">
                <label for="exampleinputname1" class="form-label fw-bold fs-5">Contact No.</label>
                <input type="text" class="form-control" id="exampleinputname1" aria-describedby="Name" name="mobile" required>
              </div>

              <div class="mb-3">
                <label for="exampleinputname1" class="form-label fw-bold fs-5">Email Address</label>
                <input type="text" class="form-control" id="exampleinputname1" aria-describedby="Name" name="email" required>
                <div id="emailHelp" class="form-text"><strong>We'll never share your email with anyone else.</strong>
                </div>
              </div>

              <div class="mb-3">
                <label for="exampleinputname1" class="form-label fw-bold fs-5">Message</label>
                <textarea class="text-area" placeholder="Leave a message here" id="mesagetextarea" name="message" required></textarea>

              </div>
              <div class="mb-3 contact-submit">
