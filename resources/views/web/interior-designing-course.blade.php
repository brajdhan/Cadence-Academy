        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    <h1 class="mb-2 text-white">Interior Designing</h1>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-2">
                    <div class="about-wrapper">
                        <img src="{{ asset('assets/images/interior-designing/interior-big2.jpg')}}" alt="image" class="home-img shadow" width="100%" height="700px">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="section-title-wrap">
                        <h2 class="title causes-heading"> <strong class="col1">INTERIOR DESIGN</strong> COURSE IN NAGPUR
                        </h2>
                        <h3 class="subtitle causes-text italic">The course is designed with the global study of interior
                            design current scenario. Cadence professional experts help you achieve your goal.</h3>
                        <div class="under-line-short"></div>
                        <p class="text-justify causes-text mb-0">
                            Cadence academy, Wadhaman Nagar provides an interior design course in Nagpur. As the construction industry
                            has
                            been growing by leaps and bounds there has been an infinite scope for interior designers. In
                            the
                            present scenario, with varied preferences of people, interior design has come up with
                            challenging and promising career opportunities. There is a need for the Education of
                            Interior
                            Design to meet the developmental requirements and aspirations of the society which is
                            rapidly
                            growing. Adequate facilities for training Interior Designers have become a matter of
                            urgency.
                            Interior Design education which calls for a creative approach must expose a student to the
                            total
                            environment and develop a philosophy consistent with the traditions, indigenous technology,
                            and
                            social and economic needs of the people. <br>

                            The demand for qualified Interior Designers is growing and at the same time, there are no
                            facilities for Interior Design education. A large number of candidates seeking admission,
                            who
                            otherwise are fully capable of pursuing the course of studies in the interior have to be
                            turned
                            away for the lack of adequate facilities for interior design education. <br>
                            There is, therefore an urgent need to bring the standards of Interior design education to a
                            level commensurate with the needs of the time. The ultimate aim of the training is to
                            educate
                            creative, competent, self-reliant professionals and the development of the field.
            ...
            <div class="row d-flex pt-4">
                ...
                <div class="col-md-12 col-lg-4 py-2">
                    <div class="divbox">
                        <div class="row">
                            <div class="col-md-12 ">
                                <h3 class=" font2 causes-text">Diploma in Interior Design(DID)</h3>
                                <ul>
                ...
                <div class="col-md-12 col-lg-4 py-2">
                    <div class="divbox">
                        <div class="row">
                            <div class="col-md-12 ">
                                <h3 class=" font2 causes-text">Advanced Diploma in Interior Design(ADID)</h3>
                                <ul>
                ...
                <div class="col-md-12 col-lg-4 py-2">
                    <div class="divbox">
                        <div class="row">
                            <div class="col-md-12 ">
                                <h3 class=" font2 causes-text">B.Voc in Interior Design(B.Voc IT)</h3>
                                <ul>
                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6 ftco-animate">
                        ...
                        <p class="text-white-90 text-justify causes-text">
                            A renowned ISO 9001-2008 certified Fashion and Interior Design Institute which was
                            established
                            in the year
                            2002 to
