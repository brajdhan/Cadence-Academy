    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 col-lg-7 col-sm-12 pt-2 ftco-animate">
          <h2> Edit Gallery  <a class="btn btn-primary" href="{{route('admin.gallery')}}">Back To Gallery</a></h2>
          
          <div>
            <br>
          <form action="{{route('admin.image-update',$id)}}" method="post" enctype="multipart/form-data">
                  @csrf
                  ...
                  <div class="mb-3">
                    <input type="file" class="form-control" id="name" name="image_name" required>
                  </div>
