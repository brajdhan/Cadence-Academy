      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page"  href="{{ route('admin.course')}}">Course Enquiry</a>
            </li>
        ...
        <div class="col-md-12 col-lg-7 col-sm-12 pt-2 ftco-animate">
          ...
          <div>
            <table class="table">
              ...
              <tbody>
                @forelse($courseEnquiry as $enquiry)
                <tr>
                ...
                @empty
                <tr>
                    <td colspan="6">There are no gallery.</td>
                </tr>
              @endforelse
              </tbody>
            </table>
            {!! $courseEnquiry->withQueryString()->links('pagination::bootstrap-5') !!}
          </div>
        </div>
      </div>
    </div>
